...
- [ ] Support more skills such as pulling, pushing, pressing buttons, placing, opening/closing doors, etc.
- [ ] Support more scenarios: retirement homes, coffee shops, etc. Currently, the scene is [online](https://necolizer.github.io/RM-PRT/), and the scene interaction function is to be added.
